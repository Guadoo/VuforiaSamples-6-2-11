...
namespace {
    ...
    */
    ...
    const float kObjectScaleNormal = 0.08f;
    const float kObjectScaleOffTargetTracking = 0.002f;
}
...
- (id)initWithFrame:(CGRect)frame appSession:(SampleApplicationSession *) app
{
    ...
    if (self) {
        ...
        sampleAppRenderer = [[SampleAppRenderer alloc]initWithSampleAppRendererControl:self deviceMode:Vuforia::Device::MODE_AR stereo:false nearPlane:1 farPlane:0.05];
    ...
    for (int i = 0; i < state.getNumTrackableResults(); ++i) {
        ...
        if (offTargetTrackingEnabled) {
            ...
            */
            ...
            //Goku
            /*
            glVertexPointer(3, GL_FLOAT, 0, GokuSS3Verts);
            glTexCoordPointer(2, GL_FLOAT, 0, GokuSS3TexCoords);
            */
            ...
            */
            ...
            //GokuSS3
            glVertexAttribPointer(vertexHandle, 3, GL_FLOAT, GL_FALSE, 0, (const GLvoid *)GokuSS3Verts);
            glVertexAttribPointer(textureCoordHandle, 2, GL_FLOAT, GL_FALSE, 0, (const GLvoid*)GokuSS3TexCoords);
        ...
        if (offTargetTrackingEnabled) {
            ...
            //GokuSS3
            glDrawArrays(GL_TRIANGLES, 0, GokuSS3NumVerts);
